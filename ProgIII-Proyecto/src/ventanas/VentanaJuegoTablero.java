...
public class VentanaJuegoTablero extends JFrameIMG
{
                ...
                public void run() {
                    ...
                    VentanaJuegoTablero.this.pAreaJuego.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseReleased(final MouseEvent arg0) {
                            final CoordTablero sueltaRaton = VentanaJuegoTablero.this.pixsToCoord(arg0.getX(), arg0.getY());
                            if (VentanaJuegoTablero.this.pulsacionRaton != null && !VentanaJuegoTablero.this.pulsacionRaton.equals(sueltaRaton) && VentanaJuegoTablero.this.estaEnTablero(VentanaJuegoTablero.this.pulsacionRaton) && VentanaJuegoTablero.this.estaEnTablero(sueltaRaton)) {
                        ...
                        public void mousePressed(final MouseEvent arg0) {
                            VentanaJuegoTablero.access$11(VentanaJuegoTablero.this, VentanaJuegoTablero.this.pixsToCoord(arg0.getX(), arg0.getY()));
                        }
    ...
    private CoordTablero pixsToCoord(int pixX, int pixY) {
        pixX -= this.origenX;
        pixY -= this.origenY;
        return new CoordTablero(Math.round(pixY / this.pixelsPorFila - 0.5f), Math.round(pixX / this.pixelsPorColumna - 0.5f));
    }
    ...
    private void calcTamanyo() {
        ...
        if (this.casillasCuadradas) {
            if (this.pAreaJuego.getHeight() > this.pAreaJuego.getWidth()) {
                ...
                this.pRelleno1.setBounds(0, 0, this.pAreaJuego.getWidth(), this.origenY);
    ...
    public boolean estaEnTablero(final CoordTablero ct) {
        return ct.getFila() >= 0 && ct.getFila() < this.filasTablero && ct.getColumna() >= 0 && ct.getColumna() < this.colsTablero;
    }
    ...
    public CoordTablero getPosTablero(final ObjetoDeJuego oj) {
        final CoordTablero ct = this.pixsToCoord(Math.round(oj.getX() + this.pixelsPorColumna / 2.0f), Math.round(oj.getY() + this.pixelsPorFila / 2.0f));
        return ct;
    }
    ...
    public static void main(final String[] args) {
        ...
        final VentanaJuegoTablero v = new VentanaJuegoTablero(960, 720, FILAS, COLS, true);
        v.showMessage("Juego en curso");
        final ObjetoDeJuego o1 = new ObjetoDeJuego("UD-blue.jpg", true, v.getAnchoCasilla(), v.getAltoCasilla());
        final ObjetoDeJuego o2 = new ObjetoDeJuego("UD-red.jpg", true, v.getAnchoCasilla(), v.getAltoCasilla());
        final ObjetoDeJuego o3 = new ObjetoDeJuego("UD-green.jpg", true, v.getAnchoCasilla(), v.getAltoCasilla());
        final ObjetoDeJuego o4 = new ObjetoDeJuego("noExiste.jpg", true, v.getAnchoCasilla(), v.getAltoCasilla());
    ...
    static /* synthetic */ void access$2(final VentanaJuegoTablero ventanaJuegoTablero, final ArrayList arrastresRaton) {
        ventanaJuegoTablero.arrastresRaton = (ArrayList<CoordTablero>)arrastresRaton;
    }
    
    static /* synthetic */ void access$11(final VentanaJuegoTablero ventanaJuegoTablero, final CoordTablero pulsacionRaton) {
